              ...
              <div class="col-md-12">
                <div class="card mb-4">
                  <div class="card-header"><h3 class="card-title">{{$page_name}}  Report</h3>
                    <button style="float:right" type="button" class="btn btn-primary btn-md " data-toggle="modal" data-target="#modal-default">Add Income</button>
                        ...
                        <tr class="align-middle">
                          ...
                          <td>
                            <div class="btn-group" role="group" aria-label="Basic example">
                                ...
                                <button type="button" class="btn btn-danger delete_records" onClick="handleDelete('tbl_income','id','<?php echo  $row->id;?>')"><i class="fa fa-trash"></i></button>
                              </div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title">Income Slab</h4>
          <button type="button" class="close float-right" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>          
        <div class="modal-body">
        <form action="" id="income_form" name="income_form" method="POST">
          @csrf
          <div class="form-group">
            <label for="text">Income Slab Name</label>
  ...
  <script>
    ...
    $(document).ready(function() 
   {
       ...
       var keyCode = event.keyCode || event.which; 
         ...
         var action = $('#income_form').attr('action');    
