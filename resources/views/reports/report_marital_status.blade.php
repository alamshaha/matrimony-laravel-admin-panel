...
<main class="app-main">
              ...
              <div class="col-md-12">
                <div class="card mb-4">
                  <div class="card-header"><h3 class="card-title">{{$page_name}}  Report</h3>
                    <button style="float:right" type="button" class="btn btn-primary btn-md " data-toggle="modal" data-target="#modal-default">Add Marital Status</button>
                        ...
                        <tr class="align-middle">
                          ...
                          <td>
                            <div class="btn-group" role="group" aria-label="Basic example">
                                ...
                                <button type="button" class="btn btn-danger delete_records" onClick="handleDelete('tbl_marital_status','id','<?php echo  $row->id;?>')"><i class="fa fa-trash"></i></button>
                              </div>
                  ...
                  <div class="card-footer clearfix">                  
                    {{ $marital_status->links('pagination::bootstrap-4') }}
                  </div>
                </div>
                <!-- /.card -->
  ...
  <div class="modal fade" id="modal-default">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form action="" id="marital_status" name="marital_status" method="POST">
          @csrf
  ...
  <script>
    ...
    $(document).ready(function() 
   {
       ...
       $("#marital_status").submit(function (event) {
       var keyCode = event.keyCode || event.which; 
          
         event.preventDefault();
         var action = $('#marital_status').attr('action');    
