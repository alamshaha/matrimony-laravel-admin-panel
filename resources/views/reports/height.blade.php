...
<main class="app-main">
              ...
              <div class="col-md-12">
                <div class="card mb-4">
                  <div class="card-header"><h3 class="card-title">{{$page_name}}  Report</h3>
                    <button style="float:right" type="button" class="btn btn-primary btn-md " data-toggle="modal" data-target="#modal-default">Add Height</button>
                  ...
                  <div class="card-footer clearfix">                  
                    {{ $height->links('pagination::bootstrap-4') }}
                  </div>
                </div>
                <!-- /.card -->
  ...
  <div class="modal fade" id="modal-default">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form action="" id="height_form" name="height_form" method="POST">
          @csrf
          <div class="form-group">
            <label for="text">Height Name</label>
  ...
  <script>
    ...
    $(document).ready(function() 
   {
       ...
       $("#height_form").submit(function (event) {
       var keyCode = event.keyCode || event.which; 
          
         event.preventDefault();
         var action = $('#height_form').attr('action');    
