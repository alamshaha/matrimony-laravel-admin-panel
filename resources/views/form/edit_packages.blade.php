                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="card card-primary card-outline mb-4">
                                            ...
                                            <form id="package_form">
                                                ...
                                                <input type="hidden" name="id" class="form-control" id="id"  value="{{$package_data[0]->id}}">
                                                <!--begin::Body-->
                                                <div class="card-body">                                                  
                                                    <div class="mb-3">
                                                        <label for="validationCustom04" class="form-label">Package Name </label>
                                                        <input type="text" class="form-control" id="package_name" name="package_name" value="{{$package_data[0]->package_name}}" >
                                                     </div>                              
                                                    <div class="mb-3">
                                                        <label for="validationCustom04" class="form-label">Price </label>
                                                        <input type="number" class="form-control" id="price" name="price" value="{{$package_data[0]->price}}"  >
                                                     </div>                                                  
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" class="form-control" id="view_member" name="view_member" value="{{$package_data[0]->view_member}}" >
                                                     </div>                                                  
                                                    <div class="mb-3">
                                                        <label for="validationCustom04" class="form-label">Description </label><br/>
                                                        <textarea class="form-control" rows="4"  name="description">{{$package_data[0]->description}}</textarea>
                                                     </div>                                                  
                                                </div>
